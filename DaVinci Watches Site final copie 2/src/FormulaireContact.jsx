...
export const ContactUs = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_r5fvidq', 'template_gywpaoa', form.current, {
  ...
  return (
    <form ref={form} onSubmit={sendEmail} className="flex flex-col gap-6">
      <h2 className="text-3xl font-semibold mb-2 text-left">Contactez-nous</h2>
      <p className="mb-6 text-left text-lg text-gray-700">Nos équipes répondront à votre demande au plus vite.</p>
      ...
      <div className="flex flex-col gap-2">
        <label htmlFor="sujet" className="text-base font-medium text-gray-900">Sujet</label>
        <input
          id="sujet"
          type="text"
          name="sujet"
